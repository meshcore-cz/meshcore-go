module github.com/meshcore-cz/meshcore-go/examples/send-channel-msg

go 1.25.6

require github.com/meshcore-cz/meshcore-go v0.0.0
...
replace github.com/meshcore-cz/meshcore-go => ../../
